...
import { UserMgmtResetPasswordAuthUIProps } from './UserMgmt/UserMgmt.ResetPasswordAuthUI';
import { UserMgmtEmailVerifiedAuthUIProps } from './UserMgmt/UserMgmt.EmailVerifiedAuthUI';
...
import { UserMgmtErrorAuthUIProps } from './UserMgmt/UserMgmt.ErrorAuthUI';

const UserMgmtErrorAuthUI = dynamic<UserMgmtErrorAuthUIProps>(
  () =>
    import('./UserMgmt/UserMgmt.ErrorAuthUI').then(
      (x) => x.UserMgmtErrorAuthUI
    ),
  { ssr: false }
);
const UserMgmtResetPasswordAuthUI = dynamic<UserMgmtResetPasswordAuthUIProps>(
  () =>
    import('./UserMgmt/UserMgmt.ResetPasswordAuthUI').then(
...
const UserMgmtEmailVerifiedAuthUI = dynamic<UserMgmtEmailVerifiedAuthUIProps>(
  () =>
    import('./UserMgmt/UserMgmt.EmailVerifiedAuthUI').then(
