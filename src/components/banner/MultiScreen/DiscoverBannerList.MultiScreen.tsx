...
export const DiscoverBannerListDesktop: FC<IProps> = (props) => {
  return (
    <div className="text-white space-x-5 flex w-full h-full relative box-border">
      ...
      <DiscoverBannerListColumn
        ...
        className="flex"
      />
      <div className="h-[100] px-[0.5px] bg-[rgba(255,255,255,0.15)] relative hidden lg-1040:flex" />
      <DiscoverBannerListColumn
        Heading="Our choices"
        ContentArray={props.ContentArray}
        className="hidden lg-1040:flex"
      />
    </div>
  );
};

export const DiscoverBannerListTablet: FC<IProps> = (props) => {
  return (
    <Swiper
      slidesPerView={2.93}
      spaceBetween={20}
