    ...
    <div className="flex w-full overflow-x-hidden overflow-y-visible mt-[50px]">
      <div className="flex relative box-border space-x-5 md-900:space-x-6 p-5">
        {props.ContentArray.map((value, index) => (
          <div key={index} className="text-white relative button-text-lower p-0 m-0 rounded-2xl overhidden bg-opacity-5 bg-white">
            <div className="p-0 m-0">
              ...
              <div className="px-5 pt-4 pb-[70px] space-y-2">
                <h6 className="text-[16px] md-900:text-[18px] font-normal text-left w-full">
                  {value.Heading}
                </h6>
            ...
            <Button className="text-white absolute bottom-0 block whitespace-nowrap mx-5 mb-4 p-0 text-[14px] hover:underline underline-offset-4 font-sans font-normal button-text-lower"
              sx={{
