  ...
  return (
    <div className="p-3 flex space-x-3 relative justify-end">
      ...
      <Button
        ...
        className="text-white disabled:opacity-50 disabled:text-white disabled:cursor-not-allowed rounded-md  text-[11px] h-8 w-[calc(100%/3)] bg-[#0074E4] hover:bg-[#0074E4] outline-none button-text-lower"
      >
        Done
      </Button>
    </div>
