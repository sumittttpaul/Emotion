  ...
  return (
    <>
      ...
      >
        <motion.ul
          variants={UlVariants}
          className="space-y-5 pt-3 pb-5 bg-[#121212] w-full"
        >
          ...
          <motion.li variants={LiVariants}>
            <div className="flex flex-col w-full relative space-y-3.5 overflow-x-hidden">
              ...
              <motion.button
                ...
                initial={{ x: -50 }}
                animate={LeftAnimate}
                className="left-3 absolute p-0 z-[1] bottom-[50px] h-[32px] w-[20px] bg-white bg-opacity-70 hover:bg-white rounded-[4px] transition-colors color-transition Custom-DropShadow"
              >
                <div className="h-full w-full flex items-center justify-center">
                  <Image
              ...
              <motion.button
                ...
                className="right-3 absolute p-0 z-[1] bottom-[50px] h-[32px] w-[20px] bg-white bg-opacity-70 hover:bg-white rounded-[4px] transition-colors color-transition Custom-DropShadow"
              >
                <div className="h-full w-full flex items-center justify-center">
                  <Image
