  ...
  return (
    <AnimatePresence exitBeforeEnter>
      <motion.div
        ...
        className="text-white relative items-start justify-end rounded-t-2xl w-full h-[500px] md-900:h-[600px] px-12 pb-[130px] flex flex-col overflow-hidden bg-gradient-to-r from-[rgba(0,0,0,0.7)]"
      >
        <CarouselBannerImage
          className="-z-[1]"
        ...
        >
          ...
          >
            <h6 className="text-3xl font-[500]">
              {props.BannerTextTransition === 'open' &&
                props.ContentArray[props.CarouselState].Heading}
            </h6>
          </motion.div>
          <motion.div
            transition={{ type: 'spring', bounce: 0.15, duration: 0.3 }}
          ...
          >
            <h6 className="uppercase tracking-[0.5px] font-[500] leading-[1.3333] text-[11px]">
              {props.BannerTextTransition === 'open' &&
                props.ContentArray[props.CarouselState].Category}
            </h6>
            <h6 className="text-[15px] leading-6">
              {props.BannerTextTransition === 'open' &&
                props.ContentArray[props.CarouselState].Description}
            </h6>
          </motion.div>
          {props.BannerTextTransition === 'open' &&
          props.ContentArray[props.CarouselState].Type.toLowerCase() ===
            ...
            >
              <div className="text-xs flex items-center space-x-[4px] my-1">
                ...
                <h6>Starting at</h6>
                <h6 className="line-through opacity-70">{`₹${
                  props.BannerTextTransition === 'open' &&
                  props.ContentArray[props.CarouselState].OriginalPrice
                }`}</h6>
                <h6>{`₹${
                  props.BannerTextTransition === 'open' &&
