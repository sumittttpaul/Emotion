...
export const FooterBottom: FC = () => {
  return (
    <div className="grid grid-cols-2 grid-rows-2 gap-y-3 sm:gap-y-2 w-full mt-2 items-center sm:grid-cols-2 sm:grid-rows-2 md-900:grid-cols-2 md-900:grid-rows-2 lg-1140:grid-cols-3 lg-1140:grid-rows-1">
      ...
      <h6 className="text-[11.5px] items-start h-full sm:h-auto sm:items-center col-span-1 row-span-2 sm:row-span-2 lg-1140:row-span-1 sm:w-full order-1 md-900:order-3 justify-end md-900:justify-start lg-1140:justify-end font-[300] whitespace-normal hidden small-screen:flex text-white opacity-80">
        India
      </h6>
