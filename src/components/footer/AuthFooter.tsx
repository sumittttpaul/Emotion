  ...
  return (
    ...
    >
      <div className="w-full flex space-x-1">
        ...
        <h6 className="text-[13px] whitespace-nowrap font-normal text-white tracking-wide opacity-[0.75] flex items-center">
          means that you agree to the
        </h6>
        <Link
          href=""
          className="text-[13px] hidden xs-435:flex md:hidden hover:underline underline-offset-2 cursor-pointer whitespace-nowrap font-medium text-sky-400 tracking-wide items-center"
        >
          priavcy policy
        </Link>
      ...
      <div className="flex space-x-1 xs-435:-ml-1 md:ml-0">
        <Link
          href=""
          className="text-[13px] flex xs-435:hidden md:flex hover:underline underline-offset-2 cursor-pointer whitespace-nowrap font-medium text-sky-400 tracking-wide items-center"
        >
          priavcy policy
        </Link>
