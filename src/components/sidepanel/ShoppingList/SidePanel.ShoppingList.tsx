      ...
      <div className="flex flex-col w-full h-full overflow-hidden">
        ...
        >
          <Image
            height={22}
            width={22}
            className="opacity-50 group-hover:opacity-100 hover:transition-opacity"
            src="/icons/shopping-cart-fill.svg"
            alt=""
          />
          <p className="opacity-50 group-hover:opacity-100 hover:transition-opacity trunacate text-[14px] text-white tracking-wide font-[600] w-full text-left">
            Shopping List
          </p>
          <Image
            height={22}
